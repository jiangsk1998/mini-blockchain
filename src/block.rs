...
impl Block{
    pub fn calculate_hash_with_nonce(index: u64, timestamp: u64, data: &str, prev_hash: &str, nonce: u64) -> String {
...
impl Block{
    ...
    /// 参数： 前一个区块的引用，新区块的数据
    /// 返回： 新区块
    pub fn new(prev_block: &Block, data: String, difficulty: usize) -> Self{
        //新区块高度
